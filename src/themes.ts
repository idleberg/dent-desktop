...
const mochaTheme = EditorView.theme(
	{
		...
		'.cm-foldPlaceholder': { backgroundColor: 'transparent', border: 'none', color: '#6c7086' },
		'.cm-tooltip': { border: 'none', backgroundColor: '#313244' },
		'.cm-tooltip-autocomplete': { '& > ul > li[aria-selected]': { backgroundColor: '#45475a', color: '#cdd6f4' } },
	},
	{ dark: true },
);
...
const mochaHighlightStyle = HighlightStyle.define([
	...
	{ tag: [tags.name, tags.deleted, tags.character, tags.propertyName, tags.macroName], color: '#89b4fa' },
...
const latteTheme = EditorView.theme(
	{
		...
		'.cm-gutters': { backgroundColor: '#eff1f5', color: '#9ca0b0', border: 'none' },
		...
		'.cm-searchMatch': { backgroundColor: '#df8e1d33', outline: '1px solid #df8e1d66' },
		'.cm-searchMatch.cm-searchMatch-selected': { backgroundColor: '#40a02b33' },
		'.cm-foldPlaceholder': { backgroundColor: 'transparent', border: 'none', color: '#9ca0b0' },
...
const latteHighlightStyle = HighlightStyle.define([
	...
	{ tag: [tags.name, tags.deleted, tags.character, tags.propertyName, tags.macroName], color: '#1e66f5' },
	{ tag: [tags.function(tags.variableName), tags.labelName], color: '#1e66f5' },
	{ tag: [tags.color, tags.constant(tags.name), tags.standard(tags.name)], color: '#fe640b' },
	...
	{ tag: [tags.atom, tags.bool, tags.special(tags.variableName)], color: '#fe640b' },
	{ tag: [tags.processingInstruction, tags.string, tags.inserted], color: '#40a02b' },
